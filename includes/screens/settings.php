	...
	<div class="wemanage-welcome">
		<div class="welcome-col pb">
			<div class="wemanage-wrap about-wrap">
				...
				<h1><?php esc_html_e('Welcome to WEmanage', 'nouvello-wp-management'); ?></h1>
				<div class="about-text">
					<p><?php esc_html_e('Thank you for installing our plugin. We hope you\'ll enyoy it.', 'nouvello-wp-management'); ?><br><?php esc_html_e('Please let us know if you need any assistance.', 'nouvello-wp-management'); ?><br></p>
				</div>
				<div class="about-text">
					<h3><?php esc_html_e('Quick start', 'nouvello-wp-management'); ?></h3>
					<div style="display: flex;">
						<div>
							<img style="max-width: 80px" src="<?php echo esc_url(NSWMW_ROOT_DIR . 'includes/assets/img/one.png'); ?>"/>
						</div>
						<div>
							<h3 style="margin-top: 20px; color: rgb(50,97,169)"><?php esc_html_e('Download app', 'nouvello-wp-management'); ?></h3>
							<p><?php esc_html_e('Download free from the Apple app store or Google play store.', 'nouvello-wp-management'); ?></p>
					...
					<div style="display: flex;">
						...
						<div>
							<h3 style="margin-top: 20px; color: rgb(50,97,169)"><?php esc_html_e('Create account', 'nouvello-wp-management'); ?></h3>
							<p><?php esc_html_e('Get access to all our great features.', 'nouvello-wp-management'); ?>
					...
					<div style="display: flex;">
						...
						<div>
							<h3 style="margin-top: 20px; color: rgb(50,97,169)"><?php esc_html_e('Already have an account?', 'nouvello-wp-management'); ?></h3>

							<p><?php esc_html_e('1. Press activate to start the activation process. ', 'nouvello-wp-management'); ?><button type="button" id="activate-btn" class="button" style="color: red; border-color: red;">Activate</button></p>
			
							<p><?php esc_html_e('2. After activating connection, please copy the code below and paste it in the app.', 'nouvello-wp-management'); ?></p>
