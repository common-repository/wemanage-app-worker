...
class Nouvello_WeManage_Utm_Functions
{
    ...
    public static function wp_json_encode($string)
    {
        ...
        try {
            ...
            if (!empty($dateinterval->days) && (!empty($dateinterval->y) || !empty($dateinterval->m))) :
                ...
                $duration = sprintf(
                    ...
                    _n('%s day', '%s days', $dateinterval->days, 'nouvello-wp-management'),
                    $dateinterval->days
                );
                    ...
                    switch ($part_key):
                        case 'd':
                            ...
                            if (!empty($dateinterval->d)) :
                                $duration .= sprintf(
                                    /* translators: %s: number of days */
                                    _n('%s day', '%s days', $dateinterval->d, 'nouvello-wp-management'),
                                    $dateinterval->d
                                ) . ' ';
                        ...
                        case 'h':
                            ...
                            if (!empty($dateinterval->h)) :
                                $duration .= sprintf(
                                    ...
                                    _n('%s hour', '%s hours', $dateinterval->h, 'nouvello-wp-management'),
                                    $dateinterval->h
                                ) . ' ';
                        ...
                        case 'i':
                            ...
                            if (!empty($dateinterval->i)) :
                                $duration .= sprintf(
                                    ...
                                    _n('%s minute', '%s minutes', $dateinterval->i, 'nouvello-wp-management'),
                                    $dateinterval->i
                                ) . ' ';
                        ...
                        case 's':
                            ...
                            if (!empty($dateinterval->s)) :
                                $duration .= sprintf(
                                    ...
                                    _n('%s second', '%s seconds', $dateinterval->s, 'nouvello-wp-management'),
                                    $dateinterval->s
                                ) . ' ';
