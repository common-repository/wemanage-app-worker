...
{
    public const META_PREFIX = 'nouvello_utm_';
    public const META_PREFIX_ACTIVE = 'nouvello_utm_active_';
    ...
    public static function update_active_session($user_id, $meta_whitelist)
    {
        ...
        try {
            ...
            if (Nouvello_WeManage_Utm_Settings::get('attribution_format') === 'json') :
                ...
                //save to meta
                self::update_active_user_option($user_id, 'attribution', Nouvello_WeManage_Utm_Functions::wp_json_encode($attribution));
    ...
    public static function save_conversion_attribution($attribution, $user_id)
    {
        ...
        if (!empty($attribution)) :
            if (Nouvello_WeManage_Utm_Settings::get('attribution_format') === 'json') :
                //save to meta
                self::update_user_option($user_id, 'attribution', Nouvello_WeManage_Utm_Functions::wp_json_encode($attribution));
            else :
