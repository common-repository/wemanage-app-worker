...
{
    public const COOKIE_PREFIX_NAME = 'nouvello_utm_';

    public const COOKIE_EXPIRY_SHORT = 604800; //7 days
    public const COOKIE_EXPIRY_MEDIUM = 2592000; //30 days
    public const COOKIE_EXPIRY_LONG = 7776000; //90 days

    public const DEFAULT_CONVERSION_TYPE = 'lead';
    ...
    public static function set_cookies($meta_array = array())
    {
        ...
        try {
            ...
            $main_cookie_json = wp_json_encode($main_cookie);
